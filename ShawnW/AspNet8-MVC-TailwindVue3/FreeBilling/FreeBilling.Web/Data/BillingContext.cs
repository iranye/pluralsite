...
public class BillingContext : IdentityDbContext<TimeBillUser>
{
    ...
    public BillingContext(DbContextOptions<BillingContext> options, IConfiguration config) : base(options)
    {
        this.config = config;        
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        // var connectionString = config["ConnectionStrings:DBConnectionString"]; // For Env Vars on other OSs, use ConnectionStrings__DBConnectionString
